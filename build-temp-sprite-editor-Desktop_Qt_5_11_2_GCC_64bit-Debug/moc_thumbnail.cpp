...
#include "../temp-sprite-editor/thumbnail.h"
...
QT_MOC_LITERAL(1, 10, 26), // "send_thumbnail_click_event"
QT_MOC_LITERAL(2, 37, 0) // ""

    },
    "Thumbnail\0send_thumbnail_click_event\0"
    ""
};
...
void Thumbnail::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->send_thumbnail_click_event((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Thumbnail::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thumbnail::send_thumbnail_click_event)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Thumbnail::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_Thumbnail.data,
      qt_meta_data_Thumbnail,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void Thumbnail::send_thumbnail_click_event(int _t1)
{
